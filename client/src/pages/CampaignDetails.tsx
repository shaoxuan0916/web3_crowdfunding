          ...
          <div className="mt-[20px] flex flex-col p-4 bg-[#1c1c24] rounded-10px">
            ...
            <div className="mt-[30px]">
              <input
                ...
                placeholder="ETH 0.1"
                step="0.001"
                className="w-full py-[10px] sm:px-[20px] px-[15px] border-1 border-[#3a3a43] bg-transparent font-epilogue text-white text-[18px] leading-[30px] placeholder:text-[#4b5264] outline-none"
                value={amount}
